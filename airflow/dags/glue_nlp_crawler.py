...
with DAG('glue_nlp_crawler_dag', 
         description='Run Glue NLP Crawler',
    ...
    crawler_name = 'de1-1-1st-cleaned-data-crawler'
    
    start_crawler(crawler_name=crawler_name) >> check_crawler_status(crawler_name=crawler_name) >> log_final_message() >> trigger_glue_nlp_dag_task