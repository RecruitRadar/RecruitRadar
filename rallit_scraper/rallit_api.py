...
class Scraper:
    ...
    @staticmethod
    def save_to_json(data_list: List[Dict[str, Union[str, List[str]]]]) -> str:
...
def main() -> None:
    ...
    # Instead of os.environ.get(), we use os.getenv() as it's more idiomatic
    ...
    print(f"Total scraped items: {len(data_list)}")
